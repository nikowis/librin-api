...
import pl.nikowis.librin.domain.message.dto.ConversationNotFoundException;
...
import pl.nikowis.librin.domain.user.dto.CantCreateConversationOnNonActiveOfferException;
